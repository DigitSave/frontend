  ...
  return (
    <section className="w-full m-h-screen px-6 py-10">
      <div className="flex flex-col md:flex-row gap-4 w-full">
        <div className="w-full md:w-3/5 flex flex-col gap-4 p-6 bg-center rounded-lg bg-[url('/images/stats-bg.png')]">
        ...
        <div className="w-full md:w-2/5 p-6 bg-[#2B2B2B80] rounded-lg">
